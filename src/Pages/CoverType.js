...
function CoverType(covertype_props) {

    const DatabaseName = "cover_type";
    ...
    covertype_props.setpageactivation(true);
    covertype_props.titleset(covertype_props.pagename);
    ...
    return (
        <div className="card">
            <div className="card-header">
                <h1> {covertype_props.pagename}</h1>
