...
function ExtraType(extratype_props) {

    const DatabaseName = "extra_type";
    ...
    extratype_props.setpageactivation(true);
    extratype_props.titleset(extratype_props.pagename);
    ...
    return (
        <div className="card">
            <div className="card-header">
                <h1> {extratype_props.pagename}</h1>
