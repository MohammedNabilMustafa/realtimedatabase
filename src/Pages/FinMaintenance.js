...
function FinMaintenance(Maintenace_props) {
    Maintenace_props.setpageactivation(true);
    Maintenace_props.setsubpageactivation(true);
    Maintenace_props.titleset(Maintenace_props.pagename);
    ...
    return (
        <>
        <FinSettingList maintenancesubpageactivation={Maintenace_props.subpageactivation}/>

        <div className="card">
            <div className="card-header">
                <h1> {Maintenace_props.pagename}</h1>
