...
function FinMarketing(Marketing_props) {
    Marketing_props.setpageactivation(true);
    Marketing_props.setsubpageactivation(true);
    Marketing_props.titleset(Marketing_props.pagename);

    const DatabaseName = "marketing";
    ...
    return (
        <>
        <FinSettingList marketingsubpageactivation={Marketing_props.subpageactivation}/>

        <div className="card">
            <div className="card-header">
                <h1> {Marketing_props.pagename}</h1>
