...
function FinOther(Other_props) {
    Other_props.setpageactivation(true);
    Other_props.setsubpageactivation(true);
    Other_props.titleset(Other_props.pagename);

    const DatabaseName = "other";
    ...
    return (
        <>
        <FinSettingList othersubpageactivation={Other_props.subpageactivation}/>

        <div className="card">
            <div className="card-header">
                <h1> {Other_props.pagename}</h1>
