...
function FinRent(Rent_props) {
    Rent_props.setpageactivation(true);
    Rent_props.setsubpageactivation(true);
    Rent_props.titleset(Rent_props.pagename);

    const DatabaseName = "rent";
    ...
    return (
        <>
        <FinSettingList rentsubpageactivation={Rent_props.subpageactivation}/>

        <div className="card">
            <div className="card-header">
                <h1> {Rent_props.pagename}</h1>
