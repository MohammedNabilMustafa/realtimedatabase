...
function FinStatistics(finstatistics_props) {
    ...
    finstatistics_props.setpageactivation(true);
    finstatistics_props.titleset(finstatistics_props.pagename);
    ...
    return (
        <div className="card">
            <div className="card-header">
                <h1> {finstatistics_props.pagename}</h1>
