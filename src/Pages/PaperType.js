...
function PaperType(papertype_props) {

    const DatabaseName = "paper_type";
...

    {
        ...
        type: "text",
        name: "cal_way",
        label: 'طريقة حساب الورق',
        dataValue: paperCal,
        onchange: Empty_func,
        placeholder: 'طريقة حساب الورق',
        ref: useRef()
    }
        ,
        ...
        ref.onSnapshot((querySnapshot) => {
            ...
            querySnapshot.forEach((doc) => {
                ...
                let ret = paperCal.filter((it) => {
                    let check = it.id === saved_data.cal_way

                    if (check) {
                        saved_data.cal_way = it.name
                        return check
                    }
                    ;
                })
    ...
    function getdatabase_paper_cal() {
