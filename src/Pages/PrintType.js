...
function PrintType(printtype_props) {

    const DatabaseName = "print_type";
    ...
    printtype_props.setpageactivation(true);
    printtype_props.titleset(printtype_props.pagename);
    ...
    return (
        <div className="card">
            <div className="card-header">
                <h1> {printtype_props.pagename}</h1>
